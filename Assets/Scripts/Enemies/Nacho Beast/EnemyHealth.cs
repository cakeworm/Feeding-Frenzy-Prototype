   ...
   public NBStatePatternEnemy enemy;
    ...
    public void TakeDamage(int amount, Vector3 hitPoint)
    {
        ...
        {    
            ...
            NBStatePatternEnemy enemy = GetComponent <NBStatePatternEnemy>();
        ...
        if (currentHealth <= 0)
        {
            ...
            NBStatePatternEnemy nBStatePatternEnemy = GetComponent<NBStatePatternEnemy>();
            if (nBStatePatternEnemy != null)
            {
                nBStatePatternEnemy.SetAlive(false);
                Debug.Log ("I'm dead");
