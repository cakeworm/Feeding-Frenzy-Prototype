...
public class NachoCreeperChaseState :  IEnemyState 

{
    ...
    public NachoCreeperChaseState (NCStatePatternEnemy statePatternEnemy)
    {
    ...
    private void Jump()
    {
        ...
        enemy.rigidbody.AddForce (Vector3.up * 4.0f, ForceMode.VelocityChange);
