...
public class GPEnemyHealth : MonoBehaviour 
{
   ...
   public GPStatePatternEnemy enemy;
    ...
    void Awake ()
    {
       ...
       //hitParticles = GetComponentInChildren <ParticleSystem> ();
        ...
        enemy = GetComponent <GPStatePatternEnemy>();
    ...
    public void TakeDamage(int amount, Vector3 hitPoint)
    {
        ...
        {    
            ...
            GPStatePatternEnemy enemy = GetComponent <GPStatePatternEnemy>();
        ...
        if (currentHealth <= 0)
        {
            ...
            GPStatePatternEnemy gPStatePatternEnemy = GetComponent<GPStatePatternEnemy>();
            if (gPStatePatternEnemy != null)
            {
                gPStatePatternEnemy.SetAlive(false);
                Debug.Log ("I'm dead");
